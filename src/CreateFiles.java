...
* run on your machine you will have to change the file path locations for tempFileLocation and inputFileLocation.
*
* @author Mike Hoyt
*/
...
public class CreateFiles {
	...
	private final String tempFileLocation = "/home/mike/Documents/Practice/ExternalSort/TempFiles";
	private final String inputFileLocation = "/home/mike/Documents/Practice/ExternalSort/inputFiles/million";
	...
	*/
	private File writeToFile(int[] arr) {
		File temp = null;
		try {
			temp = File.createTempFile("tmp", null, new File(tempFileLocation));
			temp.deleteOnExit();
	...
	*/
	...
	public static void main(String[] args) {
		new CreateFiles(inputFileLocation);
	}
}